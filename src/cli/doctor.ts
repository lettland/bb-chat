...
/**
 * `bbchat doctor` — re-run detection and a health check against the resolved config.
 * Read-only diagnostics: it explains whether `bbchat` can reach BB and what launch
